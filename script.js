function generatePassword(){
  ...
  let randomText = randomJ.substring(Math.floor(Math.random() * randomJ.length),Math.floor(Math.random() * randomJ.length) + 4);
  
  let randomText2 = randomJ.substring(Math.floor(Math.random() * randomJ.length),Math.floor(Math.random() * randomJ.length) + 4);
